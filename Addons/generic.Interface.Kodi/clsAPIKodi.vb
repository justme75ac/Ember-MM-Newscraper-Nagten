        ...
        Private Async Function GetHostJSONVersion() As Task(Of APIVersionInfo)
            ...
            Try
                ...
                Select Case String.Concat(nAPIVersionInfo.Major.ToString, nAPIVersionInfo.Minor)
                    ...
                    Case Else
                        Select Case nAPIVersionInfo.Major.ToString
                            Case "8"
                                nAPIVersionInfo.Codename = "Krypton"
                            Case "10"
                                nAPIVersionInfo.Codename = "Leia"
                            Case "12"
                                nAPIVersionInfo.Codename = "Matrix"
                        End Select
                End Select
                ...
                If KodiElement IsNot Nothing Then
                    ...
                    If Master.eSettings.GeneralDigitGrpSymbolVotes Then
                        If mDBElement.Movie.VotesSpecified Then
                            Dim vote As String = Double.Parse(mDBElement.Movie.Votes, Global.System.Globalization.CultureInfo.InvariantCulture).ToString("N0", Global.System.Globalization.CultureInfo.CurrentCulture)
                    ...
                    Dim mRating As Double = If(mDBElement.Movie.RatingSpecified, CType(Double.Parse(mDBElement.Movie.Rating, Global.System.Globalization.CultureInfo.InvariantCulture).ToString("N1", Global.System.Globalization.CultureInfo.CurrentCulture), Double), 0)
                    ...
                    For Each oldArtwork In KodiElement.art.Where(Function(f) Not mArtwork.ContainsKey(f.Key) AndAlso Not f.Key.StartsWith("set"))
                ...
                If KodiElement IsNot Nothing Then
                    ...
                    If Master.eSettings.GeneralDigitGrpSymbolVotes Then
                        If mDBElement.TVEpisode.VotesSpecified Then
                            Dim vote As String = Double.Parse(mDBElement.TVEpisode.Votes, Global.System.Globalization.CultureInfo.InvariantCulture).ToString("N0", Global.System.Globalization.CultureInfo.CurrentCulture)
                            If vote IsNot Nothing Then
                                mVotes = vote
                            End If
                        End If
                    ...
                    Dim mRating As Double = If(mDBElement.TVEpisode.RatingSpecified, CType(Double.Parse(mDBElement.TVEpisode.Rating, Global.System.Globalization.CultureInfo.InvariantCulture).ToString("N1", Global.System.Globalization.CultureInfo.CurrentCulture), Double), 0)
                    Dim mRuntime As Integer = 0
                ...
                If KodiElement IsNot Nothing Then
                    ...
                    If Master.eSettings.GeneralDigitGrpSymbolVotes Then
                        If mDBElement.TVShow.VotesSpecified Then
                            Dim vote As String = Double.Parse(mDBElement.TVShow.Votes, Global.System.Globalization.CultureInfo.InvariantCulture).ToString("N0", Global.System.Globalization.CultureInfo.CurrentCulture)
                            If vote IsNot Nothing Then
                                mVotes = vote
                            End If
                        End If
                    ...
                    'integer or 0
                    Dim mRating As Double = If(mDBElement.TVShow.RatingSpecified, CType(Double.Parse(mDBElement.TVShow.Rating, Global.System.Globalization.CultureInfo.InvariantCulture).ToString("N1", Global.System.Globalization.CultureInfo.CurrentCulture), Double), 0)
